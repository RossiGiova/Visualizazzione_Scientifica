...
plt.scatter(df['special-attack'], df['special-defense'], color='lightsalmon', alpha=0.9, edgecolor='k')
plt.title('Relazione tra Attacco speciale e Difesa speciale dei Pokémon')
